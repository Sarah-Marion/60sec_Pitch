...
# from flask import db, photos, mail
from flask import render_template, redirect, request, url_for, flash, abort
from flask_login import login_user, login_required, current_user
from flask_user import UserManager, roles_required
from .forms import LoginForm, BioForm, PostForm
from .import admin
...
@admin.route('/profile/<uname>/update',methods = ['GET','POST'])
@login_required
...
@admin.route('/profile/<uname>/update/pic',methods= ['POST'])
@login_required
...
def admin():
    user_admin = User.query.filter(User.username == 'admin@admin.com').first()
